...
\caption{Shows detials of spicule SP:B where panel (a-c) show the same analysis carried out for Fig.~\ref{fig:spa} and the bottom 2 panels show the the corresponding wavelet analysis as done in Fig.~\ref{WL_1}. This figure is taken from \cite{Dover2020ApJ90572D} and was created by Dr. Sharma.}
\label{fig:spb} 
\end{centering}
\end{figure*}
%
...
\caption{Show details of spicule SP:C where panel (a-c) show the same analysis carried out for Fig.~\ref{fig:spa} and the bottom 2 panels show the the corresponding wavelet analysis as done in Fig.~\ref{WL_1}. This figure is taken from \cite{Dover2020ApJ90572D} and made by Dr. Sharma.}
\label{fig:spc} 
\end{centering}
\end{figure*}
